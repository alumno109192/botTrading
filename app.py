...
try:
    ...
    DatabaseManager().init_tf_bias_table()
    DatabaseManager().migrate_add_telegram_thread_id()
    logger.info("✅ Tablas api_key_usage, ohlcv, canal_roto_state, macro_events_log, bot_logs, nivel_touches, senal_analisis, bot_antispam, tf_bias_state listas")
