...
SIMBOLOS = {
    'XAUUSD': {
        'ticker_yf':          'GC=F',
        'zona_resist_high':   4920.0,       # Resistencia 1H: zona $4880-4920 (actualizado 15-abr-2026, precio ~$4833)
        'zona_resist_low':    4880.0,
        'zona_soporte_high':  4790.0,       # Soporte 1H: zona $4750-4790
        'zona_soporte_low':   4750.0,
        'tolerancia':         40.0,
