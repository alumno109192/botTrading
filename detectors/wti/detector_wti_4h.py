...
try:
    ...
    if turso_url and turso_token:
        ...
        db = DatabaseManager()
        print("✅ Sistema de tracking de BD activado (WTI 4H)")
    else:
...
def main():
    print("🚀 Detector WTI OIL 4H iniciado")
    enviar_telegram("🚀 <b>Detector WTI OIL 4H iniciado</b>\n"
                    "━━━━━━━━━━━━━━━━━━━━\n"
    ...
    while True:
        ciclo += 1
        print(f"\n[{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}] 🔄 CICLO #{ciclo} - WTI OIL 4H")
